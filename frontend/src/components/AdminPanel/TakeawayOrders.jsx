...
function TakeawayMenu() {
    ...
    const kotHTML = `
      ...
      ">
        ...
        <div style="font-size:11px; margin-bottom:3px;">
          <strong>Customer:</strong> ${tableNumber}<br />
          <strong>Date:</strong> ${new Date().toLocaleString()}
        </div>

        <hr style="border-top:1px dashed #000; margin:3px 0;" />

        <table style="width:95%; margin:0 auto; font-size:11px; border-collapse:collapse;">
          <thead>
            <tr>
            ...
            ${order
              ...
              <tr>
                <td style="text-align:left;">
                  ...
                  ${
                    item.instructions
                      ? `<em style="font-size:10px;">${item.instructions}</em>`
                      : ""
                  }
                </td>
      ...
      <html>
        <head>
          ...
          <style>
            ...
            body { margin: 0; padding: 0; width: 3in; height: 5in;
              font-family: 'Courier New', monospace;
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      await printKOT(customerName || "Takeaway", order);
  ...
  return (
    <div className="py-2">
      ...
      <div className="sticky-top bg-white px-3 py-2 mb-2 border-bottom shadow-sm" style={{ top: "0", zIndex: 100 }}>
        <input
          type="text"
      ...
      <div className="row">
        ...
        {order.length > 0 && (
          <div
            className="d-none d-lg-flex flex-column bg-white border rounded shadow-sm p-3"
            style={{
              position: "sticky",
              top: "20px",
              right: "20px",
